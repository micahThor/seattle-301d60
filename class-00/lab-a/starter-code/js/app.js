...
function displayPics(){
  ...
  // When the variable rando was defined with 'var' it was accessible to this console.log() because var is global scoped.  When I changed rando to 'let' the scope of the variable is defined within the while loop on line 33.  Anywhere outside of this while loop the rando variable is unreachable.
  console.log(viewed);
